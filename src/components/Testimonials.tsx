...
const testimonials = [
  {
    ...
    text: 'RGSK Technologies delivered an exceptional website that exceeded our expectations. Their team was professional and responsive throughout. The design was modern, SEO-optimized, and our organic traffic increased by 150% within three months of launch.',
    rating: 5,
  },
  {
    name: 'Nitesh Yadav',
    ...
    text: 'The bulk WhatsApp service has transformed how we communicate with customers. We can now reach thousands of parents and students instantly. The delivery rates are excellent and the analytics dashboard helps us track engagement effectively.',
    rating: 5,
  },
  {
    ...
    text: 'Outstanding mobile app development and great post-launch support. RGSK Technologies is our go-to tech partner. They delivered the project ahead of schedule and the app has maintained a 4.8-star rating on the Play Store.',
    rating: 5,
  },
  {
    name: 'Priya Sharma',
    post: 'Managing Director',
    company: 'Sharma Enterprises Lucknow',
    text: 'We hired RGSK Technologies for our e-commerce website and bulk SMS campaigns. Sales increased by 200% in the first quarter. Their understanding of the local Lucknow market combined with technical expertise is unmatched.',
    rating: 5,
  },
  {
    name: 'Rajesh Kumar',
    post: 'Operations Head',
    company: 'Kumar Healthcare Solutions',
    text: 'RGSK built our patient management system from scratch. The software is intuitive, HIPAA-compliant, and has reduced our administrative workload by 60%. Their ongoing support and regular updates keep everything running smoothly.',
    rating: 5,
  },
  {
    name: 'Ankit Verma',
    ...
    text: 'From ideation to deployment, RGSK Technologies handled our entire digital transformation. The custom CRM they developed has streamlined our sales pipeline and improved team productivity by 40%. Truly a world-class development partner.',
    rating: 5,
  },
]
