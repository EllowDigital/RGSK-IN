  ...
  return (
    <section id="blog" className="section-padding bg-secondary/30">
      <div className="container mx-auto px-4">
        <div
          ref={ref}
          className={cn(isVisible ? 'scroll-visible' : 'scroll-hidden')}
        >
          {/* Section Header */}
          ...
          <div className="text-center">
            <Link to="/blog">
              <Button variant="outline" className="gap-2 group border-primary/30 text-primary hover:bg-primary hover:text-primary-foreground">
                View All Articles
