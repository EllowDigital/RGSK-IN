import { Globe, Smartphone, Share2, Phone, MessageCircle, ArrowRight, Sparkles } from 'lucide-react'
          ...
          {!isReady ? (
            ...
            services.map((service, index) => (
              ...
              >
                ...
                <p className="relative text-muted-foreground mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
                  {service.description}
                </p>
